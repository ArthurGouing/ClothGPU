...
## Class rendering a 3D mesh
class Mesh3DRenderable(AbstractRenderable):
    ...
    def updatePositionsBuffer(self):
        ...
        positions = np.array(self.mesh.positions, \
    ...
    def updateColoursBuffer(self):
        ...
        colours = np.array(self.mesh.colours, \
    ...
    def draw(self, viewMatrix, projectionMatrix,
        ...
        GL.glPointSize(8)
        # GL.glDrawElements(GL.GL_POINTS, self.mesh.indices.size, GL.GL_UNSIGNED_INT, None)
